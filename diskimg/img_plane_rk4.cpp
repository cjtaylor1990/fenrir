...
int main(int argc, char* argv[]){
    ...
    while (j < n){
        ...
        while (k < n){
            ...
            angmom = -1.*imgB*std::sin(alpha)*(imgX/imgB); //phi angular momentum
            ...
            double momOneForm[4]; //defining momentum 4-vector
            momOneForm[0] = (gTT(posVec[1],posVec[3],posVec[2],posVec[0])*momVec[0])+(gTPh(posVec[1],posVec[3],posVec[2],posVec[0])*momVec[3]); //time
            momOneForm[1] = (gRR(posVec[1],posVec[3],posVec[2],posVec[0])*momVec[1]); //radius
            momOneForm[2] = (gThTh(posVec[1],posVec[3],posVec[2],posVec[0])*momVec[2]); //theta
            momOneForm[3] = (gPhT(posVec[1],posVec[3],posVec[2],posVec[0])*momVec[0])+(gPhPh(posVec[1],posVec[3],posVec[2],posVec[0])*momVec[3]); //phi
