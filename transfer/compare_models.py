...
path1 = '/Users/cjtaylor/sparse_grid/fenrir_models/'
path2 = '/Users/cjtaylor/sparse_grid/relxill_models/'
outPath = '/Users/cjtaylor/sparse_grid/refspec_overplots/'
...
while (index < len(aList)):
	...
	pl.title(r'Ref Spec Comparison: a = ' + str(round(aList[index],3)) + ', i = ' + str(round(iList[index],3)) + ', SoSD = ' + str(round(sumSqrDiff,3)))
