...
filePath = '/Users/cjtaylor/github/fenrir/zoomin/'
fileNames = [filePath + 'zoomin_r10.npy',filePath+'zoomin_r30.npy',filePath+'zoomin_r100.npy']
outFile = filePath + 'zoomin_fenrir.npy'
