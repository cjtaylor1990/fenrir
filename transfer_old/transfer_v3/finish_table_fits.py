...
into seperate FITS table objects, and then combine those new table objects with the transfer function tables already
calculated: [header,spin,mu,table1,table2,...]. It should then rename each of the transfer function tables
by a pair of dummy indices.
"""
...
col4 = fits.Column(name = 'trff1', format = '200E', unit = 'k=1', array = tranArray1)
col5 = fits.Column(name = 'trff2', format = '200E', unit = 'k=2', array = tranArray2)
