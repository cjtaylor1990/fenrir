...
int numAcc; //the number of Mdot values being explored
double initAcc; //the first Mdot value being explored
double finalAcc; //the final Mdot being explored
double deltaAcc; //the change in Mdot between the different Mdot values
double accretion; //the current mass accretion rate
