...
inputFiles = [inputPrefix + '_' + str(i) + '.npy' for i in range(numberInputFiles)]

#Reading input parameters from command line
outputPrefix = str(sys.argv[3]) #Output FITS file prefix
heightIndex = int(sys.argv[4])
outFile = outputPrefix + '_' + str(heightIndex) + '.fits'
